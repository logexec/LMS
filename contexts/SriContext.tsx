      ...
      try {
        ...
        for (let i = 1; i < rawData.length; i++) {
          ...
          const newRow: ExcelRow = {
            ...
            fecha: String(row[47] || "").trim(),
            aut_factura: String(row[13] || "").trim(),
            precio: typeof row[81] === 'number' ? row[81] : parseFloat(String(row[81] || "0")),
        ...
        setState((prev) => ({ 
          ...prev, 
          isLoading: false, 
          error: "Error al procesar el archivo Excel. Verifique que el formato sea correcto." 
        }));
      }
    },
