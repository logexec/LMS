          ...
          <div className="flex items-center space-x-4 mb-6">
            <div className="relative">
              <input
                ...
                className="pl-10 pr-4 py-2 border border-gray-600 text-gray-800 placeholder-gray-400 rounded-lg focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-transparent"
              />
              <svg
